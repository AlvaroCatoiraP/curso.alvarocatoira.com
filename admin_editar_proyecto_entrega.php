    ...
    if ($titulo === '' || $descripcion === '' || $orden_entrega <= 0) {
        ...
        if ($error === '') {
            try {
                ...
                $success = "Entrega actualizada correctamente.";
                ...
                if ((int)$e->getCode() === 23000) {
                    $error = "Ya existe otra entrega con ese orden dentro de este proyecto.";
                } else {
                    $error = "Error al actualizar la entrega: " . $e->getMessage();
                }
            }
        }
    }
...
<body class="bg-slate-950 text-white min-h-screen">
    <div class="max-w-5xl mx-auto p-8">
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4 mb-8">
            <div>
                <h1 class="text-3xl font-bold">Editar entrega</h1>
                <p class="text-slate-400 mt-2">Modifica los datos de esta fase del proyecto.</p>
            </div>
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6 mb-8">
            ...
            <div class="mt-4 text-slate-300 space-y-2">
                <p><strong>ID entrega:</strong> <?= (int)$entrega['id'] ?></p>
                <p><strong>Orden actual:</strong> <?= (int)$entrega['orden_entrega'] ?></p>
            </div>
        </div>
        ...
        <div class="bg-slate-900 border border-slate-800 rounded-2xl p-6">
            <h2 class="text-2xl font-bold mb-6">Modificar datos de la entrega</h2>
